...
interface AppContextType {
  ...
  signInWithPassword: (email: string, password: string) => Promise<void>; signUpWithPassword: (email: string, password: string, name: string, phone: string, role: Exclude<UserRole, 'admin'>) => Promise<{ confirmationRequired: boolean }>; logout: () => Promise<void>;
